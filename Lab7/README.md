...
CDC verification can be run from the JasperGold directory:

```bash
cd Lab7/Exercise/05_JG
make jg
```

The CDC report checks the handshake and asynchronous FIFO crossing schemes.

![CDC Pass](img/CDC_pass.png)
